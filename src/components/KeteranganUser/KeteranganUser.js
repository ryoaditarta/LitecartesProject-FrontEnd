...
const KeteranganUser = (nama, sekolah, diamond, energy, tier) => {
        ...
        <View className="flex-row justify-center items-center bg-buttonColor rounded-b-3xl" style={{ height: '20%' }}>
            <View className="flex-row justify-around gap-1 mt-10">
                ...
                <View className=" flex-col gap-1 items-center mr-4">
                    <Text className="text-cream text-xl" style={{ fontFamily: 'NunitoBold' }}>Maudy Ayunda</Text>
                ...
                <View className="flex flex-col items-center justify-center" style={{ widht: '20' }}>
                    <View className="flex-row justify-between gap-1 mb-1">
                        <View className="bg-cream w-12" style={{ borderRadius: 30 }}>
                            <Text className="text-center text-buttonColor" style={{ borderRadius: 10, fontFamily: 'NunitoReg' }}>250</Text>
                        </View>
                        <View className="bg-cream w-12" style={{ borderRadius: 30 }}>
                            <Text className="text-buttonColor text-center" style={{ borderRadius: 10, fontFamily: 'NunitoReg' }}>150</Text>
                        </View>
                    </View>
                    <View className="bg-cream w-full p-1" style={{ borderRadius: 10 }}>
                        <Text className="text-xs text-buttonColor text-center" style={{ fontFamily: 'NunitoReg' }}>Voyager</Text>
                    </View>
                </View>
            </View>
        </View>
