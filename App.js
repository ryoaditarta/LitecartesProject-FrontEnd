  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName='LoginOrRegister'>
        ...
        <Stack.Screen name="Pretest" component={Pretest} options={{ headerShown: false }} />
        <Stack.Screen name="YaySelesaiPretest" component={YaySelesaiPretest} options={{ headerShown: false }} />
        <Stack.Screen name="MainMenu" component={MainMenu} options={{ headerShown: false }} />
        <Stack.Screen name="DoTasks" component={DoTasks} options={{ headerShown: false }} />
        <Stack.Screen name="EvaluationScreen" component={EvaluationScreen} options={{ headerShown: false }} />
        <Stack.Screen name="TesPretest" component={TesPretest} options={{ headerShown: false }} />
